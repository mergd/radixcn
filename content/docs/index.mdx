...
You can use any framework that supports React. [Next.js](https://ui.fldr.zip/docs/installation/next), [Astro](https://ui.fldr.zip/docs/installation/astro), [Remix](https://ui.fldr.zip/docs/installation/remix), [Gatsby](https://ui.fldr.zip/docs/installation/gatsby) etc.
