...
You can use any framework that supports React. [Next.js](https://ui.radixcn.com/docs/installation/next), [Astro](https://ui.radixcn.com/docs/installation/astro), [Remix](https://ui.radixcn.com/docs/installation/remix), [Gatsby](https://ui.radixcn.com/docs/installation/gatsby) etc.
